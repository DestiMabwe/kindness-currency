...
export function AgeGate({ templateName, onConfirm, onDismiss }: AgeGateProps) {
  return (
    <div className="fixed inset-0 z-[80] flex items-end bg-[#1A1A2E]/55 backdrop-blur-[3px]">
      <div className="w-full rounded-t-[26px] rounded-b-[36px] bg-[#FFF8F0] px-6 pt-7 pb-7.5">
        <div className="flex h-[54px] w-[54px] items-center justify-center rounded-2xl bg-[#7B3F61] text-2xl text-white">☾</div>
        <div className="mt-4 text-2xl font-extrabold text-[#1A1A2E] italic" style={{ fontFamily: 'var(--font-playfair)' }}>
          A grown-up gift
        </div>
